...
/**
 * kWL contains all classes related to running the WL combinatorial method.
 * <p>
 * At the moment, the implementation only supports permutation groups which are
 * either declared in code or given in permutation group form by GAP.
 * 
